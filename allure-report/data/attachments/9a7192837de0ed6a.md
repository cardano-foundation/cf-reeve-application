...
- Name: tests/e2e/reprocess-transactions.feature.spec.js >> Users can reprocess transactions that are in pending status once the issue is solved, system checks >> Reprocess transaction sent to pending by parent cost center mapping
- Location: .features-gen/tests/e2e/reprocess-transactions.feature.spec.js:13:7
