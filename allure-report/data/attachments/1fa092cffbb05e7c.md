...
- Name: tests/e2e/reprocess-transactions.feature.spec.js >> Users can reprocess transactions that are in pending status once the issue is solved, system checks >> Reprocess transaction sent to pending by parent project code mapping
- Location: .features-gen/tests/e2e/reprocess-transactions.feature.spec.js:34:7

# Error details

```
Error: The sent credit code is not the same imported in the system
