...
- Name: tests/e2e/reprocess-transactions.feature.spec.js >> Users can reprocess transactions that are in pending status once the issue is solved, system checks >> Reprocess transaction in pending status by cost center mapping
- Location: .features-gen/tests/e2e/reprocess-transactions.feature.spec.js:6:7
...
```ts
  ...
  6   | import {commonTestActions} from "../../helpers/common-test-actions";
  7   | import {transactionsBuilder} from "../../helpers/transactionsBuilder";
  8   | import {CostCenterDto} from "../../api/dtos/costCenterDto";
  9   | import {ChartOfAccountsDto} from "../../api/dtos/chartOfAccountsDto";
