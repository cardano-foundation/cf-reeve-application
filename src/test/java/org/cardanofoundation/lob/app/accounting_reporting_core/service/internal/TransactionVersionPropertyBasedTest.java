...
class TransactionVersionPropertyBasedTest {
    ...
    void compute_shouldChangeHashForDifferentFields(@ForAll("transactionTypes") TransactionType transactionType1,
        ...
        val tHash1 = TransactionVersionCalculator.compute(ERP, t1);

        // Change transaction type
        t1.setTransactionType(transactionType2);
        val tHash2 = TransactionVersionCalculator.compute(ERP, t1);
        ...
        val tHash3 = TransactionVersionCalculator.compute(ERP, t1);
        ...
        val tHash4 = TransactionVersionCalculator.compute(ERP, t1);
        ...
        val tHash5 = TransactionVersionCalculator.compute(ERP, t1);
