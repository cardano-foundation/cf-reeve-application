...
//    Streamable<TransactionEntity> findByValidationStatus(@Param("organisationId") String organisationId,
...
//    Streamable<TransactionEntity> findBlockchainPublisherPendingTransactions(@Param("organisationId") String organisationId,
...
//                                                                             @Param("ledgerDispatchApproved") boolean ledgerDispatchApproved);
    ...
    @Query("SELECT t.id FROM accounting_reporting_core.TransactionEntity t WHERE t.organisation.id = :organisationId AND t.ledgerDispatchStatus IN :dispatchStatuses AND t.validationStatus IN :validationStatuses AND t.ledgerDispatchApproved = :ledgerDispatchApproved")
    Streamable<String> findTransactionIdsByStatuses(@Param("organisationId") String organisationId,
                                                    @Param("dispatchStatuses") List<LedgerDispatchStatus> dispatchStatuses,
                                                    @Param("validationStatuses") List<ValidationStatus> validationStatuses,
                                                    @Param("ledgerDispatchApproved") boolean ledgerDispatchApproved);
