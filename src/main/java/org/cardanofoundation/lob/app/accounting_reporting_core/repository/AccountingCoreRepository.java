...
public interface AccountingCoreRepository extends JpaRepository<TransactionLineEntity, String> {
    ...
    @Query("SELECT tl FROM accounting_reporting_core.TransactionLineEntity tl WHERE tl.organisationId = :organisationId AND tl.transactionInternalNumber = :txInternalNumber")
